...
<head><meta name="viewport" content="width=device-width,initial-scale=1"/>
  ...
  <style>
    ...
    pre { background:#eee; padding:8px; white-space:pre-wrap; font-family:monospace; }
...
<body>
  ...
  <h2>Example PID Settings</h2>
  <pre>
// line-follower-robochallenge-2023
// PID
#define KP 0.3
#define KI 0.001
#define KD 10

// HyperLine-Robotics-Line-Follower-V3
// PID constants
#define KP 0.22
#define KI 0.008
#define KD 9.2
