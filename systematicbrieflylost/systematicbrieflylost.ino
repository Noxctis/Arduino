...
// Speed Settings
// ---------------------
int defaultSpeed         = 135;
const int pivotBaseSpeed = 130;
const int searchSpeed    = 100;

// ---------------------
// Tuning & Thresholds
// ---------------------
const int pivotThreshold    = 1500;  // very sharp turn
const int deadbandThreshold = 20;    // ignore tiny errors
const unsigned long dashDuration = 750; // max ms to treat as “dashed” gap
...
void loop() {
  ...
  // 4) Compute error (freeze at lastError if lost)
